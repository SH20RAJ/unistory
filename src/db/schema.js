...
export const referralCodes = sqliteTable("referral_codes", {
  ...
  type: text("type").default("standard"), // standard, limited, special
...
export const referralRewards = sqliteTable("referral_rewards", {
  ...
  userId: text("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  type: text("type").notNull(), // points, achievement, badge, special
  value: integer("value"), // points amount or reward value
...
export const events = sqliteTable("events", {
  ...
  requiresRSVP: integer("requires_rsvp", { mode: "boolean" }).default(true),
  allowWaitlist: integer("allow_waitlist", { mode: "boolean" }).default(false),
...
export const achievements = sqliteTable("achievements", {
  ...
  category: text("category").notNull(), // study, social, event, content, special, referral
  type: text("type").notNull(), // streak, milestone, activity, seasonal, referral
...
export const userStats = sqliteTable("user_stats", {
  ...
  referralPointsEarned: integer("referral_points_earned").default(0),
...
export const notifications = sqliteTable("notifications", {
  ...
  type: text("type").notNull(), // like, comment, match, study_room, achievement, connection, event, mood_reminder, club_update, referral
  title: text("title").notNull(),
...
export const usersRelations = relations(users, ({ many, one }) => ({
  ...
  receivedReferrals: many(referrals, { relationName: "receivedReferrals" }),
