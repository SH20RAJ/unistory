    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900">
            ...
            <section className="container mx-auto px-4 py-20 text-center">
                <Badge className="mb-6 bg-blue-100 text-blue-800 hover:bg-blue-200 dark:bg-blue-900 dark:text-blue-100">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                    Connect with verified college students, share confessions anonymously,
                    find study buddies, and build meaningful relationships in a safe, psychology-driven environment.
                </p>

                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                    <div className="flex w-full sm:w-auto">
                        <Input placeholder="Enter your .edu email" className="rounded-r-none w-64" />
                        <Button
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto text-sm text-gray-600 dark:text-gray-400">
            ...
            <section className="container mx-auto px-4 py-20">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold mb-4">Everything You Need for College Life</h2>
                    <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        From anonymous confessions to study groups, we've built features that understand college student psychology
                    </p>
                </div>

                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* Secret Crush Feature */}
                    <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-pink-50 to-red-50 dark:from-pink-900/20 dark:to-red-900/20">
                        <CardHeader>
                        ...
                        <CardContent>
                            <p className="text-gray-600 dark:text-gray-300">
                                Anonymously choose up to 5 people. If there's a match, both get notified. Safe, private, and exciting.
                            </p>
                        </CardContent>
                    </Card>
